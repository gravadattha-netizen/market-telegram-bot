...
# =========================================================
ADMIN_MESSAGE = """**ကမ္ဘာ့ရေနံစိမ်းဈေးကွက် အခြေအနေ (စက်တင်ဘာ ၁၇၊ ၂၀၂၆)**

**၁။ လက်ရှိ ရေနံစိမ်းဈေးနှုန်းများ**

* **Brent Crude:** တစ်ပါပီလျှင် **၁၀၄.၅၀ - ၁၀၅.၇၀ ဒေါ်လာ** ဝန်းကျင်
* **WTI Crude:** တစ်ပါပီလျှင် **၁၀၁.၂၀ - ၁၀၂.၃၀ ဒေါ်လာ** ဝန်းကျင်

---

**၂။ ဈေးကွက်အပေါ် သက်ရောက်နေသည့် အဓိကအကြောင်းအရင်းများ**

* **ဆော်ဒီအာရေးဗီးယား ပိုက်လိုင်း ပြန်လည်ပြင်ဆင်မှု:** တိုက်ခိုက်ခံခဲ့ရသည့် East-West ရေနံပိုက်လိုင်းကို ရက်ပိုင်းအတွင်း ထက်ဝက်နီးပါး ပြန်လည်ပတ်နိုင်မည်ဟု သတင်းထွက်ပေါ်လာခြင်းကြောင့် ရောင်းလိုအား (Supply) ပိုင်း စိုးရိမ်မှုများ လျော့ကျသွားပြီး ဈေးနှုန်း အနည်းငယ် ပြန်လည်အေးခဲသွားသည်။
* **ဟော်မုဇ် ရေလက်ကြား ပို့ဆောင်မှု:** အမေရိကန် စစ်ဘက်ဆိုင်ရာ ကူညီပေးမှုများဖြင့် စက်တင်ဘာလလယ်တွင် ရေနံစိမ်းနှင့် စက်သုံးဆီ စုစုပေါင်း ပါပီ ၁၈ သန်းခန့် ဟော်မုဇ် ရေလက်ကြားကို အောင်မြင်စွာ ဖြတ်သန်းနိုင်ခဲ့သည်။
* **အမေရိကန် လက်ကျန်ပမာဏ:** အမေရိကန်၏ ရေနံစိမ်းသိုလှောင်မှု ပမာဏ (US Crude Inventories) သည် ပါပီ ၆၄၀,၀၀၀ ခန့် လျှော့နည်းသွားသော်လည်း ခန့်မှန်းချက်ထက် လျှော့နည်းမှု နည်းပါးခဲ့သည်။

---

**၃။ သုံးသပ်ချက်**

အရှေ့အလယ်ပိုင်း ရောင်းလိုအား အကျပ်အတည်းများ အနည်းငယ် ပြေလည်လာသည့် လက္ခဏာများကြောင့် **၁၀၈ - ၁၁၀ ဒေါ်လာ** အထက်အထိ တက်ခဲ့သည့် ရေနံစိမ်းဈေးနှုန်းသည် ပြန်လည်ငြိမ်သက်လာခြင်း ဖြစ်သည်။

သို့သော် ပထဝီနိုင်ငံရေး တင်းမာမှုများ ပျောက်ကွယ်မသွားသေးသဖြင့် ဈေးနှုန်းသည် ထိန်းကျသွားခြင်း မရှိဘဲ **၁၀၂ - ၁၀၇ ဒေါ်လာ** အကြား ဈေးအမြင့်ပိုင်းတွင် ဆက်လက် အတက်အဆင်း ရှိနေမည်ဟု ခန့်မှန်းရပါသည်။
