...
# Token နှင့် Chat ID (အစ်ကို့ Bot အတွက် တိုက်ရိုက်ပြင်ဆင်ပြီး)
...
def send_update():
    ...
    # တောင်းဆိုထားသည့် စာသားပုံစံအတိုင်း တိကျစွာ ပြင်ဆင်ခြင်း
    text = (
...
def auto_update_worker():
    ...
    # စက်နိုးနိုးချင်း ၅ စက္ကန့်အတွင်း ပထမဆုံး စာကို ချက်ချင်း အရင်ပို့ခိုင်းလိုက်ခြင်း
    time.sleep(5)
    send_update()
