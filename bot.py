...
# =========================================================
ADMIN_MESSAGE = """Crude Oil WTI ရဲ့ ၄ နာရီပြဇယား (4-Hour Chart) သုံးသပ်ချက်နဲ့ အနီးကပ် Breakout အရိပ်အယောင်တွေကို မြန်မာလို အနှစ်ချုပ် ရှင်းပြပေးထားပါတယ်။
📊 ၄ နာရီပြဇယား (4H Chart) ရဲ့ လက်ရှိအခြေအနေ
လက်ရှိမှာ Crude Oil ဈေးနှုန်းဟာ $79.02 သို့ ပြန်လည်မြင့်တက်လာပြီး $77.00 – $80.00 ကြားမှာ ကြားညှပ်လျက် Squeeze (ကျဉ်းမြောင်းစွာ ပိတ်မိနေသည့်) အခြေအနေမှာ ရှိနေပါတယ်။
 * အနီးကပ် လားရာ (Intraday Trend): Daily Chart မှာ Choppy (မရေမရာ) ဖြစ်နေသော်လည်း 4H Chart မှာ အောက်ခြေ Support ဖြစ်တဲ့ $76.60 – $77.00 ဝန်းကျင်မှ ပြန်လည် ရုန်းထွက်နိုင်ခဲ့သဖြင့် Short-term Rebound (ခဏတာ အတက်) ပြသနေပါတယ်။
 * 4H Moving Averages: ဈေးနှုန်းသည် 4H 20/50 EMAs တို့၏ အထက်သို့ ပြန်လည်ရောက်ရှိနေပြီး $81.03 (20-day SMA) နှင့် Ichimoku Cloud အောက်ခြေကို သွားရောက် စိမ်ခေါ်ရန် ပြင်ဆင်နေပါတယ်။
 * Momentum (RSI/MACD): 4H RSI သည် 52 – 55 ဝန်းကျင်သို့ ရောက်ရှိလာပြီး Neutral အထက်သို့ အနည်းငယ် ရောက်ရှိလာသဖြင့် အတက်ဘက် အဟုန် ရယူရန် ကြိုးစားနေပါတယ်။
🎯 ၄ နာရီပြဇယား၏ အရေးကြီး အဆင့်များ (Key Turning Points)
၁။ အထက်ဘက် ခုခံအဆင့်များ (Resistance Boundaries)
 * $78.90 – $79.50 (Immediate Pivot Zone): လက်ရှိ ရောက်ရှိနေသည့် နေရာဖြစ်ပြီး 50-day SMA ၏ အရေးကြီး ခုခံအဆင့် ဖြစ်ပါတယ်။
 * $81.03 – $82.50 (Major Breakout Zone): 20-day SMA နှင့် Ichimoku Cloud confluence ဆုံစည်းရာ နေရာဖြစ်ပြီး၊ $82.50 အထက် 4H Candle စက်နက်စွာ ပိတ်နိုင်မှသာ အတက်ဘက်သို့ Trend အပြည့်အဝ ပြောင်းလဲမည် ဖြစ်ပါတယ်။
၂။ အောက်ဘက် ပံ့ပိုးအဆင့်များ (Support Boundaries)
 * $76.63 – $77.00 (Critical Support Belt): 200-day SMA ၏ အဓိက ခံစစ်စည်း ဖြစ်ပြီး ဝယ်သူများ ဇောက်ထိုး မကျအောင် ထိန်းထားသည့် နေရာဖြစ်ပါတယ်။
 * $74.50 (Structure Low): $76.63 ကျိုးပေါက်ပါက ဒုတိယမြောက် ရောက်ရှိမည့် အဓိက Floor ဖြစ်ပါတယ်။
⚡ ၄ နာရီပြဇယား အရောင်းအဝယ် Scenarios များ
                          [ $82.50 / $85.00 Bullish Target ]
                                     ▲
                                     │ (4H Candle Close Above $82.50)
                                     │
   [ $78.90 50-SMA Confluence ] ───► Current Price ~$79.02 ◄─── Chop Zone ($77.00 - $80.00)
                                     │
                                     │ (4H Candle Close Below $76.60)
                                     ▼
                          [ $74.50 / $68.50 Bearish Target ]

🟢 အတက်ဘက် အတည်ပြုချက် (Bullish Breakout Play)
 * ဝင်ရောက်ရမည့်အချက် (Trigger): 4H Candle သည် Cloud Resistance ဖြစ်သည့် $82.50 အထက်တွင် အားကောင်းစွာ ပိတ်နိုင်လျှင်။
 * ပစ်မှတ် (Targets): $85.00 / $94.00
 * အရှုံးဖြတ်ရန် (Stop Loss): $78.50 အောက်
🔴 အကျဘက် ပြန်ကွေ့ချက် (Bearish Breakdown Play)
 * ဝင်ရောက်ရမည့်အချက် (Trigger): 4H Candle သည် $76.60 (200 SMA) အောက်သို့ လျှောကျ ပိတ်နိုင်လျှင်။
 * ပစ်မှတ် (Targets): $74.50 / $68.50
 * အရှုံးဖြတ်ရန် (Stop Loss): $79.50 အထက်
💡 အဓိက သတိပြုရန်
ဈေးနှုန်းသည် $77.00 မှ $80.00 ကြား "Chop Zone" အတွင်း၌သာ ရှိနေသေးသဖြင့် Breakout မဖြစ်မီ ကြိုတင် မဝင်ရောက်ဘဲ $82.50 ကျော်တက်ခြင်း သို့မဟုတ် $76.60 အောက်သို့ ကျဆင်းခြင်း ကို အတည်ပြုချက် ခဲ့ပြီးမှသာ Trend အတိုင်း လိုက်ပါ အရောင်းအဝယ် လုပ်ဆောင်ခြင်းက အန္တရာယ် ကင်းဆုံး ဖြစ်ပါမည်။

💡 ပြည်တွင်း local market အရ လာမည့် အပါတ်တွင် PPRD ရည်ညွှန်းဈေး ဆီအမျိူးအစားအားလုံး ၁၅၀ ကျပ် မှ ၂၀၀ ကျပ် ဝန်းကျင် ကျဆင်းနိုင်ပါသည်/
