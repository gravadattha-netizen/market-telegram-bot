...
# =========================================================
ADMIN_MESSAGE = """* လက်ရှိဈေးနှုန်း: $81.86 (+0.64 / +0.79%)
* Trend အနေအထား:
    * ဇူလိုင်လအစပိုင်းတွင် အောက်ခြေ $68.00 ဝန်းကျင်အထိ ကျဆင်းခဲ့ပြီးနောက် ပုံမှန် အတက်ဘက် (Upward Trend) သို့ ပြန်လည် ဦးတည်ခဲ့ရာ အမြင့်ဆုံး $93.00 - $94.00 နီးပါးအထိ ရောက်ရှိခဲ့ပါတယ်။
    * ထို့နောက် $75.00 - $76.00 ဝန်းကျင်သို့ ပြန်လည် ပြင်ဆင်ကျဆင်း (Pullback/Correction) ခဲ့ပြီး လက်ရှိတွင် ထို Support Level မှ ပြန်လည် အရှိန်ယူကာ Higher Low တစ်ခုကို ပုံဖော်နေပါတယ်။
* MA 5 (Moving Average): ဈေးနှုန်းသည် MA 5 မျဉ်းနီအထက်သို့ ပြန်လည်ရောက်ရှိနေပြီး တိုတောင်းသော အတက်အဟုန် (Short-term Bullish Momentum) ကို ပြသနေပါတယ်။
🎯 အရေးကြီးသော Key Levels များ
အဆင့် (Levels)	ဈေးနှုန်း (Price)	သုံးသပ်ချက်
ခုခံအဆင့် (Resistance 1)	$84.00 – $85.00	အနီးစပ်ဆုံး တားဆီးချက် ဖြစ်ပြီး၊ ယခု အတက်အရှိန် ဆက်သွားနိုင်ရန် ဖြတ်ကျော်ရမည့် ပထမ ဂိတ်ဖြစ်သည်။
ခုခံအဆင့် (Resistance 2)	$87.00 – $88.00	ယခင် တက်ခဲ့သည့် အမြင့်ဆုံး ရေလှိုင်း၏ Swing High Zone ဖြစ်သည်။
ခံစစ်အဆင့် (Support 1)	$80.00	စိတ္တဗေဒအရ အဓိက ခံစစ်စည်း ဖြစ်ပြီး MA 5 မျဉ်းနှင့် နီးစပ်သည်။
ခံစစ်အဆင့် (Support 2)	$75.00 – $76.00	အောက်ခြေ Higher Low ပုံဖော်ခဲ့သည့် အဓိက အောက်ခြေ ခံစစ်စည်း ဖြစ်သည်။
⚡ သုံးသပ်ချက်နှင့် ကုန်သွယ်မှု ကဗျူဟာ (Trade Scenarios)
🟢 အတက်ဘက် (Bullish Scenario)
* ဈေးနှုန်းသည် $80.00 အထက်တွင် ဆက်လက် ထိန်းထားနိုင်ပါက အထက်ဘက် ခုခံအဆင့် ဖြစ်သည့် $84.00 - $85.00 သို့ ဦးတည် တက်လှမ်းနိုင်ခြေ ရှိပါတယ်။
* $85.00 အထက်သို့ အားကောင်းစွာ ခွဲထွက် (Breakout) နိုင်ပါက $87.00 - $88.00 အထိ ခရီးဆက်နိုင်ပါတယ်။
🔴 အကျဘက် (Bearish Scenario)
* လက်ရှိ တက်နေသည့် အဟုန်သည် $84.00 ဝန်းကျင်တွင် ငြင်းပယ်ခံရပါက (Rejection) $80.00 သို့ ပြန်လည် ကျဆင်းနိုင်ပါတယ်။
* $80.00 အောက်သို့ Candle ပိတ်သွားပါက အောက်ခြေ Support Zone ဖြစ်သော $75.00 - $76.00 ဘက်သို့ ပြန်လည် ဦးတည်သွားနိုင်ပါတယ်။
💡 အနှစ်ချုပ်
လက်ရှိ 1D Chart အနေအထားအရ $75.00 Support မှ ပြန်လည် ရုန်းထွက်လာသည့် Bullish Rebound ပြုလုပ်နေတာ ဖြစ်ပါတယ်။ $84.00 ဧရိယာသို့ မရောက်မီအထိ တိုတောင်းသော အတက်ဘက် (Short-term Bullish Bias) ဘက်တွင် သာလွန်နေဆဲ ဖြစ်ပါတယ်။
⚡ local PPRD သုံးသပ်ချက်အရ လာမည့် *၂၁.၈.၂၂၀၂၆ သောကြာနေ့ ဒီဇယ် ပရီမီယမ် မှာ ၁၅ ကျပ် မှ ၃၀ ထိ ဈေးတက်နိုင်ပြီး အောက်တ်ိန်းဓာတ်ဆီမှာ ၅၀ မှ ၁၀၀ ကျပ် ဝန်းကျင် ဈေးကျဆင်းနိုင်ပါသည်/
